...
def collectGreen():  
  ...
  base.hold()
  base.reset()
  LineTrack.move(colRight, 40, lambda: leftMotor.angle() < 230, side = -1)
  base.hold()
  gyro.reset_angle(0)
  wait(100)

  GyroTurn.turn(-89)
  backClaw.run_target(-50, -185)
