...
GyroTurn = PID_GyroTurn(base, 0.7, 0.05, 2.5, gyro)
...
def returnHouse1():
  ...
  curr = rightMotor.angle()
  LineTrack.move(colRight, 80, lambda: rightMotor.angle() < 1200 + curr, side = -1, target = 1100 + curr)
  base.hold()
...
def checkHouse3():
  ...
  GyroTurn.turn(89)
  base.reset()
  LineTrack.move(colLeft, 80, lambda: rightMotor.angle() < 820, target = 790, side = -1, accel = True)
  base.hold()  
  GyroTurn.turn(-89)
  base.reset()
  GyroStraightDeg.move(-40, -60)
