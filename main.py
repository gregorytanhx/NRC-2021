...
def collectGreen():  
  ...
  base.reset()
  LineTrack.move(colRight, 40, side = -1, condition = lambda: leftMotor.angle() < 230)
  base.hold()
  ...
  GyroStraight.move(40, condition = lambda: colLeft.reflection() > 40)
  base.hold()
  GyroTurn.turn(89)
  base.reset()
  GyroStraight.move(40, condition = lambda: leftMotor.angle() < 350)
  ...
  gyro.reset_angle(0)
  base.reset()
  GyroStraight.move(40, condition = lambda: leftMotor.angle() < 180)
  base.hold()
  backClaw.mid()
  GyroStraight.move(-40, condition = lambda: colRight.color() != Color.WHITE)
  base.hold()
  base.reset()
  GyroStraight.move(30, condition = lambda: leftMotor.angle() < 30)
  base.hold()
  backClaw.run_target(40, 80)
  base.reset()
  GyroStraight.move(-30, condition = lambda: leftMotor.angle() > -30)
  base.hold()
...
def collectYellow():
  ...
  base.hold()
  GyroStraight.move(25, condition = lambda: colLeft.color() != Color.BLACK or colRight.color() != Color.BLACK)
  GyroStraight.move(25, condition = lambda: colLeft.color() != Color.WHITE or colRight.color() != Color.WHITE)
  base.hold()  
  base.reset()
  GyroStraight.move(20, condition = lambda: leftMotor.angle() < 80)
  base.hold()
...
def main():
  ...
  base.hold()
  base.reset()
  GyroStraight.move(50, condition = lambda: leftMotor.angle() < 280)
  base.hold()
  GyroTurn.turn(-89)
  ...
  PID_LineSquare(base, direction=-1)
  gyro.reset_angle(0)
  PID_SingleMotorTurn(base, gyro, -179, 0.05, 1)
...
# gyro.reset_angle(0)
# base.reset()
# GyroStraight.move(40, condition = lambda: leftMotor.angle() < 160)
# base.hold()
# backClaw.mid()
# GyroStraight.move(-40, condition = lambda: colRight.color() != Color.WHITE)
# base.hold()
