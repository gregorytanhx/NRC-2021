...
LineTrack = PID_LineTrack(base, 0.15, 0.0001, 15, 40)
...
def collectGreen():  
  ...
  base.reset()
  LineTrack.move(colRight, 50, lambda: colLeft.color() != Color.BLACK, side = -1, target = 550)
  base.reset()
  gyro.reset_angle(0)
...
def returnHouse1():
  ...
  base.reset()
  LineTrack.move(colRight, 85, lambda: leftMotor.angle() < 1250, side = -1, target = 1250)
  base.hold()
